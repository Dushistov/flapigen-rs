...
subprocess.check_call(["cargo", "test"], cwd=str(os.path.join(os.path.abspath('..'), "macroslib")), shell=False)
...
subprocess.check_call(["java", "-verbose:jni", "-ea", "-Djava.library.path=" + target_dir, "-cp", "Test.jar", "com.example.Main"],
