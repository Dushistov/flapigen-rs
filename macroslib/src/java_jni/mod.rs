...
const MAX_REACHABILITY_FENCE_ARGS: usize = 12;
...
/*package*/ class {class_name} {{"#,
            ...
            let mut jni_args = Vec::with_capacity(MAX_REACHABILITY_FENCE_ARGS);

            for i in 1..=MAX_REACHABILITY_FENCE_ARGS {
